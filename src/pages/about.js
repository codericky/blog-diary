            ...
            <div className="post-page-main">
                ...
                <div className="post-main">
                    ...
                    <div className="mt-3">
                        ...
                        <p><i>Developer Diary is created with web developers in mind, but really, anyone can use it right out of the b, but minimalist enough to be easily modifiable to suit your needs.</i></p>
                        <br />
                        <h4>Features</h4>
                        <div>
